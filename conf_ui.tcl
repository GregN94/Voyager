...
#  Dec 08, 2018 07:53:42 PM CET  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -menu "$top.m81" -background {#d9d9d9} -visual {} 
    wm focusmodel $top passive
    wm geometry $top 490x684+637+138
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab50 \
        ...
        -foreground {#000000} -text {Price matrix configuration} -width 262 
    ...
    button $top.but59 \
        -background {#ef2943} -font TkDefaultFont -foreground {#000000} \
        -highlightcolor black -text Generate 
    vTcl:DefineAlias "$top.but59" "generate_new_matrix_btn" vTcl:WidgetProc "window" 1
    ttk::separator $top.tSe60 \
        -orient vertical 
    vTcl:DefineAlias "$top.tSe60" "TSeparator1" vTcl:WidgetProc "window" 1
    label $top.lab62 \
        -background {#d9d9d9} -font $::vTcl(fonts,vTcl:font9,object) \
        -foreground {#000000} -text {Generic Algorithm configuration} 
    ...
    label $top.lab78 \
        ...
        -foreground {#000000} -text {Stop condition} 
    ...
    label $top.lab86 \
        -background {#d9d9d9} -font TkDefaultFont -foreground {#000000} \
        -text Delta 
    vTcl:DefineAlias "$top.lab86" "delta_lbl" vTcl:WidgetProc "window" 1
    entry $top.ent87 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black 
    vTcl:DefineAlias "$top.ent87" "delta_entry" vTcl:WidgetProc "window" 1
    ...
    place $top.but59 \
        -in $top -x 320 -y 200 -width 98 -relwidth 0 -height 31 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tSe60 \
    ...
    place $top.lab82 \
        -in $top -x 20 -y 540 -anchor nw -bordermode ignore 
    place $top.ent83 \
        -in $top -x 110 -y 540 -width 86 -relwidth 0 -height 23 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab84 \
        -in $top -x 270 -y 540 -anchor nw -bordermode ignore 
    place $top.ent85 \
        -in $top -x 350 -y 540 -width 96 -relwidth 0 -height 23 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab86 \
        -in $top -x 270 -y 570 -anchor nw -bordermode ignore 
    place $top.ent87 \
        -in $top -x 350 -y 570 -width 66 -relwidth 0 -height 23 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tSe88 \
